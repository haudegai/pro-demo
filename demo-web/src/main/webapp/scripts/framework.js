...
$(document).ready(function(){
	...
	$('.deploy-toggle-3').click(function(){
		...
		if ($(this).find('em').hasClass('toggle-3-active-background')) {
			$(this).find('span').text('该设备有故障')
			$(this).parent().find('.deviceStatus').val("1")
		} else {
			$(this).find('span').text('该设备正常')
			//$(this).text('该设备正常')
			$(this).parent().find('.deviceStatus').val("0")
		}
		return false;
	});
